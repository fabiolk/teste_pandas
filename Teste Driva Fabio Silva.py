...
dados_emp_df = pd.read_csv("DadosEmpresa.csv")#lê o arquivo csv e salva em um dataframe
print(dados_emp_df)

print('Print no terminal as colunas do arquivo DadosEmpresa')
print(dados_emp_df.columns)#.columns retorna os rótulos do dataframe

print('Print no terminal as primeiras linhas do arquivo DadosEmpresa')
print(dados_emp_df.head())#.head() retorna as n primeiras linhas sendo por padrão n=5
...
#len()calcula o comprimento da série
#.value_counts() retorna uma série contendo a contagem das linhas de um dataframe
...
dados_end_df = pd.read_csv("DadosEndereco.csv")#lê o arquivo csv e salva em um dataframe
print(dados_end_df)
...
dados_emp_df = dados_emp_df.merge(dados_end_df)#.merge() une dataframes a partir de colunas iguais
#.to_csv() salva o dataframe em um arquivo csv sem os valores de índice
